...
func (ec *executionContext) _Authtoken_refresh_token(ctx context.Context, field graphql.CollectedField, obj *Authtoken) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Authtoken(ctx context.Context, sel ast.SelectionSet, obj *Authtoken) graphql.Marshaler {
